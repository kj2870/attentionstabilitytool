...
Cohesion: 0.09
Nodes (22): BodyGuideOverlay(), BodyGuideOverlayProps, CueState, getCueState(), REGION_BOUNDS, REGION_POSITIONS, BreathGuideProps, BODY_SEQUENCE (+14 more)
...
Cohesion: 0.1
Nodes (18): code:mermaid (flowchart TD), code:mermaid (flowchart TD), code:mermaid (flowchart LR), code:mermaid (flowchart LR), Figure 1. High-Level Measurement Pipeline, Figure 2. Eye Feature Extraction Pathway, Figure 3. Protocol Structure, Figure 4. Repeated Session Comparison (+10 more)
